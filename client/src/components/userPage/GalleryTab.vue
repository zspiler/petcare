<template>
    <v-card style="height:100%; border: none" outlined>
                    ...
                    <v-col>
                        <v-hover>
                            <template v-slot:default="{ hover }">
                                <v-card style="width: 150px; padding-top:20px" class="justify-center">
                                    <v-img
                                    ...
                                    <v-card-title class="justify-center" style="text-align:center">{{ pic.name }}</v-card-title>
        ...
        <v-card-actions class="justify-center">
            <v-btn color="primary" class="menu-btn" outlined @click="addNewPic()">Add new</v-btn>
        </v-card-actions>
        
        <!-- edit picture dialog -->
        <v-dialog
            v-model="editPicDialog"
            max-width="290"
            max-height="400"
            >
...
export default {
	...
	computed: {
        ...
        profilePictureErrors() {
			...
			!this.$v.newPicture.fileTypeValidation && errors.push("Invalid file type! Supported: .jpeg, .png");
        ...
        addPicIsInError() {
            if (this.addPic.url === '')
                ...
                return !this.$v.newPicture.fileSizeValidation || !this.$v.newPicture.fileTypeValidation;
        }
	},
	methods: {
        getProfilePicUrl() {
        ...
        saveAddPic() {
            ...
            this.pictures.push(this.addPic);
        },
        onFileChange(file) {
