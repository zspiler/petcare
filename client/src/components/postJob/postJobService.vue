	...
	<v-container fill-height>
		<v-row justify="center">
			<v-col md="5" lg="5" class="grayBorder" align="center">
				...
				<v-row>
					<v-col>
						<v-textarea class="inputField" v-model="aboutMe" />
					</v-col>
				</v-row>
				<p>My experience:</p>
				<v-row>
					<v-col>
						<v-textarea class="inputField" v-model="experience" />
					</v-col>
				</v-row>
			</v-col>
			...
			<v-col md="6" lg="6" class="grayBorder" align="center">
				...
				<form>
					...
					<v-row>
						<v-col>
							<span>
								<v-text-field required class="inputFieldSmall" v-model="name" />
							</span>
						</v-col>
						<v-col>
							<v-text-field required class="inputFieldSmall" v-model="surname" />
						</v-col>
					</v-row>
					<v-row>
						<v-col>
					...
					<v-row style="margin-bottom: -30px">
						...
						<v-col style="text-align: center; font-size: 14px"> Cost per day </v-col>
					</v-row>
					<v-row>
						<v-col>
							<v-menu
						...
						<v-col>
							<v-text-field required class="inputFieldSmall" v-model="price" />
						</v-col>
					</v-row>
					<v-row> </v-row>
					<p>
					...
					<v-btn class="mr-4" color="primary" outlined @click="postService()"
						>Post job</v-btn
					>
				</form>
			</v-col>
